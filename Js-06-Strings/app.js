...
//! Ancak javascript otomatik olarak primitive stringleri string objectlerine dönüştürür. Bu sayede, string objectlerine ait olan fonksiyonlar veya özellikleri primitive string ile kullanmak mümkün olur. Ayrıca 2 tür arasında çevrim yapmakta mümkündür.
...
//? Lenght => Bir stringin boşluklarda dahil olmak üzere kaç karakterden oluşğunuu verir.
...
for (let i = 0; i < parcalanmısMetim.length; i++) {
  if (parcalanmısMetim[i] === "IT") {
    console.log("Bu cümle IT kelimesi geciyor.");
  }
}
...
let mesaj =
  kelime2 === kelime2.split("").reverse().join("")
    ? "Bu kelime polindromdur"
    : "Bu kelime polindrom değildir.";
